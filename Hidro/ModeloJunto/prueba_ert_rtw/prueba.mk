###########################################################################
## Makefile generated for Simulink model 'prueba'. 
## 
## Makefile     : prueba.mk
## Generated on : Mon Feb 17 11:17:27 2020
## MATLAB Coder version: 3.4 (R2017b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/prueba.exe
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/HP14~1/GOOGLE~1/UNIVER~1/tesis/TRABAJ~1/modelos/Hidrico
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
MODELREF_LINK_RSPFILE_NAME = prueba_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/prueba.exe
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/prueba_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=prueba -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)/prueba_ert_rtw/prueba.c

MAIN_SRC = $(START_DIR)/prueba_ert_rtw/ert_main.c
...
%.obj : $(START_DIR)/prueba_ert_rtw/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
