...
int out(){
  ...
  //for (cont=0;cont<500;cont++){
    ...
    //Parte mecanica
    Fg =((Pg*1000)-(Patm*1000))*Ap;//Pg en rms
    if(Fg<0){Fg=0;}
    fi = 1.57079;
    ...
    if (cont>50){ini=0;} //Recordar añadirle una condición inicial
    //
    //if (cont>2000){tq=teR + tcR;}
    ...
    if (vol<55.24 && vol>=51.2 && ant2 ==1)
    {pcs2=1;}
	else if (vol<55.24 && vol>=51.2 && ant2 ==1)
    {pcs2=1;}
    ...
    {pcs2=5;}     
	else if (vol>51.2 && vol<=55.24 && ant2 ==5)
    {pcs2=6;}   
	else if (vol>51.2 && vol<=55.24 && ant2 ==6)
    {pcs2=6;}    
	else if (vol>104.10 && vol<=106.9 && ant2 ==1)
    {pcs2=7;}  
    ...
    {pcs2=9;}
	else if (vol<113 && vol>=109.7 && ant2 ==9)
    {pcs2=10;}
	else if (vol<113 && vol>=109.7 && ant2 ==10)
    {pcs2=10;}     
    ...
    //Txt
	  ...
	  strcat(text2,"\t");
	  sprintf(text3,"%5.6f",Tg1);
	  strcat(text3,"\t");
	  sprintf(text4,"%5.6f",Tg2);
	  strcat(text4,"\t");
	  sprintf(text5,"%5.6f",Tg3);
	  strcat(text5,"\t");
	  sprintf(text6,"%5.6f",Tg4);
	  strcat(text6,"\t");
	  sprintf(text7,"%5.6f",Tg5);
	  strcat(text7,"\t");
	  sprintf(text8,"%5.6f",Tg6);
	  strcat(text8,"\t");
	  ...
	  strcat(text11,"\t");
	  sprintf(text12,"%5.6f",T1);
	  strcat(text12,"\t");
	  sprintf(text13,"%5.6f",T11);
	  strcat(text13,"\t");
	  sprintf(text14,"%5.6f",T111);
	  strcat(text14,"\t");
	  sprintf(text15,"%5.6f",T2);
	  strcat(text15,"\t");
	  sprintf(text16,"%5.6f",T22);
	  strcat(text16,"\t");
	  sprintf(text17,"%5.6f",T222);
	  strcat(text17,"\t");
...
int main(int argc,char** argv) {
  ...
  //for (int i = 0;i<=1000;i++)
	...
	//printf("\n Vg: %d",cont);
	if (cont>300){exit(-1);}
	if (cont<400){cont =cont+0.01;}//poner condicion de frenado
	}
	//}
